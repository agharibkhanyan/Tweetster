...
Tweetster is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
- [X] The app contains a twitter logo asa the main icon!
